...
double PerformanceScorer::score(const GameEvent& event) {
    ...
    double gameScore = points + weightedFieldGoalsMade + weightedOffensiveRebounds +
                       weightedDefensiveRebounds + steals + weightedAssists + weightedBlockedShots -
                       weightedFieldGoalsAttempted - weightedFreeThrowsMissed -
